...
class _SecondWidget extends State<SecondWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
            children: [
              //순서대로 화면 만들기             //업무 신청, 진행중 업무, 종료된 업무
              DefaultTabController(
                  ...
                  child: Scaffold(
                      appBar: AppBar(
                        automaticallyImplyLeading: false,
                        title: TabBar(tabs: workList.map((String worklist){
                          ...
                          Scaffold(
                            //업무 목록 보여줄 부분
                              body: Align(
                                ...
                                child : showWorkList(workApplyState),
                              )
                          ),
                          //진행중 업무
                          Scaffold(
                          ...
                          onPressed: () {
                            ...
                            showDialog<String>(
                              ...
                              builder: (BuildContext context) =>  CupertinoAlertDialog(
                                ...
                                content: const Text('배송 취소는 불가능합니다.\n신중히 결정해주세요.'),
                                actions: <Widget>[
                                  TextButton(
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      setState(() {
                                        ...
                                        //업무 내용 넣기
                                        wd = workDetail(destination, time, subject, subjectCount);
                                      });
      ...
      return Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              //오늘 날짜
              Text("${ DateFormat('yyyy년 MM월 dd일').format(DateTime.now()).toString()}"),
              Text("오늘 완료 업무 : $completeWorkList 개"),
            ],
          ),
          SizedBox(height: 10,),
          Text("진행 업무 상세 정보",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
          Container(
           ...
           //위치 내용에 자동으로 맞추기
            child: Column(
              ...
              children: [
                Text("배달 장소 : ${wd.location}",style: TextStyle(fontSize: 20),),
                Text("시간 : ${wd.date}",style: TextStyle(fontSize: 20)),
                Text("품목 : ${wd.deliverySubject}",style: TextStyle(fontSize: 20)),
                Text("배달 품목 수 : ${wd.deliveryCount}",style: TextStyle(fontSize: 20)),
                Align(
                  alignment: Alignment.center,
                  child: ElevatedButton(
                      onPressed: () {
  ...
  showWorkedList() {
    //임시 종료된 업무 객체
    workDetail wd1 = new workDetail("대전시 유성구 123-1","2021년 07월 1일","전자제품",100);
    workDetail wd2 = new workDetail("대전시 유성구 123-2","2021년 07월 4일","잡화",40);
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 10,),
        Text("종료된 업무",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
        Container(
          margin: EdgeInsets.all(10),
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return Card(
                child: ListTile(
                  ...
                  //값 받아오기
                  subtitle: Text("배송시간 : ${wd1.date} \n품목 : ${wd1.deliverySubject} \n물품 수 : ${wd1.deliveryCount}"),
                ),
              );
            },
          ),
...
class workDetail{
  ...
  workDetail(String location, String date, String deliverySubject, int deliveryCount){
